...
import { TrendingUp,TrendingDown,Globe,Volume2,Shield } from "lucide-react";
                        ...
                        <div className=" lg:flex-row lg:items-center lg:justify-between gap-4">
                            <div>
                                ...
                                <p className="text-muted-foreground mt-2">
                                    Compare and discover the best cryptocurrency exchanges
                                    worldwide
                                </p>
                            </div>
                            ...
                            <div  className="relative max-w-md">
                                ...
                                <Input  placeholder="Search exchanges..." className="pl-10"/>
                            </div>
