...
import { CardContent,Card } from "../component/ui/card";
...
export default function NFTPage() {
        ...
        if(searchQuery) {
            filtered = filtered.filter(
                (collection) =>
                    ...
                    collection.slug.toLocaleLowerCase().includes(searchQuery.toLowerCase()) 
    ...
    const totalVolume = collections.reduce((sum, col) => sum + col.holders, 0)
;
    if(isLoading){
        return (
